...
# university system that displays information of Students, lecturers and staff
# the parent class should be person 
...
student = Student("Ssemujju ", "Andrew", 21, "29/U/1009", "BSc. NAtural Sciences")
lecturer = Lecturer("Dr. Engonga", "Pius", 57, "L-001", "Associate Lecturer")
staff = Staff("Gwalamubisi", "Eriya", 20, "STF-256", "Superviser")
